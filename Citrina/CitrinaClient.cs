...
namespace Citrina
{
    ...
    public class CitrinaClient : ICitrinaClient
    {
        ...
        /// </para>
        /// </summary>
        public IAuthHelpers AuthHelpers { get; }

        /// <summary>
        /// Gets methods to work with Callback API.
        /// <para>
        /// Read more about Callback API on official VK page https://vk.com/dev/callback_api
        /// </para>
        /// </summary>
        public ICallbackEventHandler CallbackApi { get; }

        /// <summary>
        /// Gets methods to work with uploader.
        /// <para>
        /// Read more about uploading files on official VK page https://vk.com/dev/upload_files
        /// </para>
        /// </summary>
        public IGenericUploader Uploader { get; }
        ...
        public CitrinaClient()
        {
            ...
            CallbackApi = new CallbackEventHandler();
            Uploader = new GenericUploader();
